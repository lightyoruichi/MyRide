...
<body>
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html"><span><img class=
                "nav-icon" src="static/img/wtf-header-icon.png"> <img class=
                "nav-icon-2x" src="static/img/wtf-header-icon-2x.png"></span>
                <span>WHAT'S THE FARE</span></a>
            </div>
        </div>
    </nav>
    ...
    <div class="container-fluid main-form-container">
        <div class="container inner-container">
            <div class="main-form">
                <form action="index.php" id="Address" method="post" name=
                "Address">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            "text"> <span class=
                            "input-group-btn"><input class="btn btn-default location-btn"
                            id="getLocation" onclick=
                            "getLocation()"><span class=
                            "input-group-btn"><span class=
                            "glyphicon glyphicon-screenshot"></span></span>
                            </input></span>
                        </div>
                    </div>
